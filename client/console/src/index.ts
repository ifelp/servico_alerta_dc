...
if (!zoneArg) {
  ...
  console.error("Uso: npm run dev -- <zona>");
  console.error("Uso: npm run start -- <zona>");
  console.error("Exemplo: npm run start -- zona_a");
  console.error("Exemplo: npm run dev -- zona_a");
  process.exit(1);
}
